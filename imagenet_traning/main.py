...
parser.add_argument("--beta4", default=0.8, type=float, help="beta4 for fame")
parser.add_argument("--use_wandb", default=False)
parser.add_argument("--eps", default=1e-5, help="epsilon for fame optimizer")
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.use_wandb:
            ...
            wandb.run.summary["best_test_accuracy"] = \
                best_acc1 if best_acc1 > wandb.run.summary["best_test_acc"] \
